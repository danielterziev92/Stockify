...
/**
 * Compile-time constants governing the behavior of the {@link com.stockify.user.domain.User} aggregate.
 *
...
public final class UserRule {
    ...
    /**
     * General rules applying to the user aggregate as a whole.
     */
    @NoArgsConstructor(access = AccessLevel.PRIVATE)
    public static final class General {

        /**
         * Message key used when a requested user account does not exist.
         * Resolved via {@code MessageSource} in the exception handler.
         */
        public static final String NOT_FOUND_MSG = "user.not.found";

        /**
         * Message key used when attempting to register an email address
         * that is already associated with an existing account.
         * Resolved via {@code MessageSource} in the exception handler.
         */
        public static final String ALREADY_EXISTS_MSG = "user.already.exists";
    }
    ...
    public static final class Status {
         ...
         * Resolved via {@code MessageSource} in the exception handler.
         */
        public static final String LOCKED_MSG = "user.status.locked";
    }
}
